...
namespace jdeMasters.Components.XmlWrapper.XmlRequest
{
    ...
    [DataContract]
    public abstract class JDEXmlRequestList: JDEXmlOperation
    {
        [XmlElement("ACTION")]
        public JDEXmlAction Action { get; set; }

        public JDEXmlRequestList(): base()
        {
            // Sets the Type mode to List
            base.Type = JDEXmlRequestTypes.List;
        }
    }
}
